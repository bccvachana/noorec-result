...
orgradient.addColorStop(0.2, "rgba(254, 181, 98, 1)");
orgradient.addColorStop(1, "rgba(254, 181, 98, 0.2)");
...
const Weight = (props) => {
    ...
    datasets: [
      {
        ...
        backgroundColor: () => {
          ...
          gradient.addColorStop(0.2, "rgba(250, 84, 88, 1)");
          gradient.addColorStop(0.95, "rgba(250, 84, 88, 0)");
          return gradient;
        },
        borderColor: "rgb(250, 84, 88)",
        pointBackgroundColor: (point) => {
          return point.dataIndex === selectIndex ? "rgb(250, 84, 88)" : "white";
        },
        pointHoverBackgroundColor: (point) => {
          return point.dataIndex === selectIndex ? "rgb(250, 84, 88)" : "white";
        },
        pointBorderColor: "rgb(250, 84, 88)",
        pointHoverBorderColor: "rgb(250, 84, 88)",
        pointBorderWidth: 3,
  ...
  const barChartData = {
    ...
    datasets: [
      {
        backgroundColor: (bar) => {
          return bar.dataIndex === selectIndex ? "rgb(250, 84, 88)" : "white";
        },
        hoverBackgroundColor: "rgb(250, 84, 88)",
        borderColor: "rgb(250, 84, 88)",
        borderWidth: 3,
        hoverBorderColor: "rgb(250, 84, 88)",
        hoverBorderWidth: 3,
      ...
      <div className="ResultContainer">
        ...
        {props.index === 4 ? (
          <div className="ChartContainer">
            ...
            <div className="line2" style={{ width: 50 * data.length }}></div>
          </div>
        ) : null}
        {/* <AnimateOnChange
          baseClassName=""
